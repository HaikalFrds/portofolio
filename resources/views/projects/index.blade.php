...
@section('content')
    <section class="mx-auto max-w-5xl px-6 pt-14 pb-8">
        <h1 data-aos="fade-up" data-aos-once="true" class="display-lg font-extrabold uppercase">Work</h1>

        <div data-aos="fade-up" data-aos-once="true" data-aos-delay="100" class="mt-8 flex flex-wrap gap-2">
        ...
        @else
            <div class="grid gap-8 sm:grid-cols-2">
                @foreach ($projects as $project)
                    <div data-aos="fade-up" data-aos-once="true" data-aos-delay="{{ min($loop->index * 80, 400) }}">
