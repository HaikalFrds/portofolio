@php
    // Satu-satunya tempat mengubah link sosial — dipakai di footer dan section Contact.
    $socials = [
        [
            'label' => 'GitHub',
            'url' => 'https://github.com/HaikalFrds',
        ...
        [
            'label' => 'LinkedIn',
            'url' => 'https://linkedin.com/in/haikal-firdaus',
        ...
        [
            'label' => 'Email',
            'url' => 'mailto:haikalfirdaus498@gmail.com',
